package com.wanda.sliding.utils;
...
public class ViewDragHelper {
  ...
  private static final int SETTLE_DURATION = 500; // ms
  ...
  public static abstract class Callback {
     ...
     *
     * <p>
     * If this method returns true, a call to {@link #onViewCaptured(android.view.View, int)} will
  ...
  private boolean forceSettleCapturedViewAt(int finalLeft, int finalTop, int xvel, int yvel) {
    ...
    mScroller.startScroll(startLeft, startTop, dx, dy, SETTLE_DURATION);
   ...
   * {@link #processTouchEvent(android.view.MotionEvent)}. If one of these methods has not been
   * called for all relevant MotionEvents to track, the information reported by this method may be
   * stale or incorrect.
   * </p>
   *
   ...
   * {@link #shouldInterceptTouchEvent(android.view.MotionEvent)} or
   * {@link #processTouchEvent(android.view.MotionEvent)}. You should only rely on the results of
   * this method after all currently available touch data has been provided to one of these two
   * methods.
   * </p>
   *
