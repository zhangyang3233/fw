...
public class ExampleSuperActivityToast extends Activity {
  ...
  /**
   * Instantiates a new OnDismissWrapper. Think of an OnDismissWrapper as an OnDismissListener with
   * a
   ...
   */
  OnDismissWrapper onDismissWrapper =
      new OnDismissWrapper(ID_ONDISMISSWRAPPER, new SuperToast.OnDismissListener() {
  ...
  public void onCreate(Bundle savedInstanceState) {
     ...
     * reattached on orientation change. If you do not do this than any
    ...
    showButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        final SuperActivityToast superActivityToast =
            new SuperActivityToast(ExampleSuperActivityToast.this, Style.getStyle(Style.RED));
