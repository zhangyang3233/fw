...
import com.fw.zycoder.customtoast.SuperCardToast;
    ...
    showButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        final SuperActivityToast superActivityToast =
            new SuperActivityToast(ExampleStyle.this, customStyle);
         ...
         * in the above code is for demonstration, just use Style.getStyle(); directly as a
         * parameter.
         *
         * 1st parameter: The current activity
         * 2nd parameter: The style object
        ...
        /**
         * Create a SuperActivityToast that uses a default style with specified animations. The
         * creation of the style object
         * in the above code is for demonstration, just use Style.getStyle(); directly as a
         * parameter.
         *
         * 1st parameter: The current activity
         * 2nd parameter: The style object
         */
        final SuperCardToast superCardToastAnimation =
            new SuperCardToast(ExampleStyle.this, defaultStyleAnimation);
