package com.fw.zycoder.demos.demos.customToast.examples;
...
import com.fw.zycoder.customtoast.SuperActivityToast;
...
public class ExampleUndoBar extends Activity {
  ...
  /**
   * This is the OnClickWrapper for the SuperActivityToast. It gets a reference to the deleted
   * object
   * via a Parcelable (our bundle that we passed earlier). This is particularly useful if an item is
   * deleted
   * and the user rotates the device, the item's data wil not be lost until the SuperActivityToast
   * disappears.
   */
  OnClickWrapper onClickWrapper =
      new OnClickWrapper(ID_UNDO_WRAPPER, new SuperToast.OnClickListener() {
        ...
        public void onClick(View view, Parcelable token) {
          ...
          if (token != null) {
            ...
            /*
             * Create a Bundle from the passed Parcelable (the Bundle we passed earlier as a
             * parameter)
             */
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    final ListView namesListView = (ListView) findViewById(R.id.names_listview);
  ...
  public boolean onContextItemSelected(MenuItem item) {
    ...
    if (item.getItemId() == R.id.delete) {
      ...
      SuperActivityToast superActivityToast =
          new SuperActivityToast(ExampleUndoBar.this, SuperToast.Type.BUTTON);
