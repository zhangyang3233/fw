...
public class BrowserFragment extends BaseBrowserFragment {
  ...
  protected void onInflated(View contentView, Bundle savedInstanceState) {
    ...
    mH5progressBar = (ProgressBar) mContentView.findViewById(R.id.h5progressBar);
  ...
  private void initWebView(final WebView webView) {
    H5WebviewHelper.initWebView(webView, new H5WebChromeClient.TitleReceivedListener() {
            ...
            }, new H5WebChromeClient.ProgressReceivedListener() {
              @Override
              public void onProgressChanged(WebView view, int newProgress) {
                mH5progressBar.setProgress(newProgress);
                if(newProgress == 100){
                  mH5progressBar.setVisibility(View.GONE);
                }else{
                  mH5progressBar.setVisibility(View.VISIBLE);
                }
              }
            }
