...
public final class Constants {
	...
	public final class Pay {
		...
		//支付宝公钥
		public static final String RSA_PUBLIC 	= "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCl8QorfUZnE++H8sA7oKs/QkGGEakWcamhKeWQ475MYOJPtvKIzX4uBcqeYUzoqtR//jXzzrlldv5KXje3m1LNDeOVfHKQL8fiMn0pjphZL8kiPI0CWqNSdCdFvu7GlALp1TsjCmta9G7CnxNGlWmzF2grRn+c7U/tKMxJYvn8dQIDAQAB";
		// 回调路径
	...
	public final class Outsite {
		// wechat
		public static final String WEIXIN_APP_KEY = App.DEBUG ? "wx0bb6d42b5dd32902" : "wxf889fa0d4781b84a";
	}
	

    public static final class Path {
    	public static final String DISK_BASE_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/reward";
