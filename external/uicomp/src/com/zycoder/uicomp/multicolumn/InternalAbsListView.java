 ...
 */
public abstract class InternalAbsListView extends InternalAdapterView<ListAdapter> implements
   ...
   * Acts upon click
   */
  private InternalAbsListView.PerformClick mPerformClick;
  ...
  public interface OnScrollListener {
     ...
     */
    public void onScroll(InternalAbsListView view, int firstVisibleItem, int
  ...
  public InternalAbsListView(Context context, AttributeSet attrs) {
    this(context, attrs, R.attr.absListViewStyle);
  }

  public InternalAbsListView(Context context, AttributeSet attrs, int defStyle) {
  ...
  public boolean showContextMenuForChild(View originalView) {
    ...
    if (longPressPosition >= 0) {
      ...
      if (mOnItemLongClickListener != null) {
        handled = mOnItemLongClickListener.onItemLongClick(InternalAbsListView.this, originalView,
   ...
   * @param x X in local coordinate
   * @param y Y in local coordinate
   * @return The rowId of the item which contains the specified point, or {@link #INVALID_ROW_ID} if
        ...
        switch (mTouchMode) {
          ...
          case TOUCH_MODE_DONE_WAITING:
            ...
            if (child != null && !child.hasFocusable()) {
              ...
              final InternalAbsListView.PerformClick performClick = mPerformClick;
  ...
  public LayoutParams generateLayoutParams(AttributeSet attrs) {
    return new InternalAbsListView.LayoutParams(getContext(), attrs);
  }

  @Override
  protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
    return p instanceof InternalAbsListView.LayoutParams;
  }
  ...
  public void reclaimViews(List<View> views) {
    ...
    for (int i = 0; i < childCount; i++) {
      ...
      InternalAbsListView.LayoutParams lp =
          (InternalAbsListView.LayoutParams) child.getLayoutParams();
  ...
  // TODO I'm not sure the purpose of onConsistencyCheck mehtod. it looks like debug related.. so
  // just comment out.
  // /**
  // * @hide
  // */
   ...
   *          in the recycler.
   *
   * @see android.widget.InternalAbsListView.RecycleBin
  ...
  class RecycleBin {
    ...
    void addScrapView(View scrap) {
      InternalAbsListView.LayoutParams lp =
          (InternalAbsListView.LayoutParams) scrap.getLayoutParams();
      if (lp == null) {
        return;
      }
    ...
    void scrapActiveViews() {
      ...
      for (int i = count - 1; i >= 0; i--) {
        ...
        if (victim != null) {
          int whichScrap = ((InternalAbsListView.LayoutParams) victim.getLayoutParams()).viewType;
