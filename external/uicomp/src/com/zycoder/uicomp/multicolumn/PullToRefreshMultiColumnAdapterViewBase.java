...
public abstract class PullToRefreshMultiColumnAdapterViewBase<T extends
    InternalAbsListView> extends PullToRefreshBase<T> implements InternalAbsListView
    .OnScrollListener {
  ...
  public PullToRefreshMultiColumnAdapterViewBase(Context context, AttributeSet attrs) {
    super(context, attrs);
    mRefreshableView.setOnScrollListener(this);
  }

  public PullToRefreshMultiColumnAdapterViewBase(Context context, Mode mode) {
    super(context, mode);
    mRefreshableView.setOnScrollListener(this);
  }
  ...
  public final void onScroll(final InternalAbsListView view, final int
      firstVisibleItem, final int visibleItemCount, final int totalItemCount) {
  ...
  public final void onScrollStateChanged(final InternalAbsListView view, final int
      scrollState) {
    if (null != mOnScrollListener) {
  ...
  public void setAdapter(ListAdapter adapter) {
    ((InternalAdapterView<ListAdapter>) mRefreshableView).setAdapter(adapter);
  }
   ...
   */
  public void setOnItemClickListener(InternalAbsListView.OnItemClickListener listener) {
  ...
  public final void setOnScrollListener(InternalAbsListView.OnScrollListener listener) {
  ...
  private void addIndicatorViews() {
    ...
    if (mode.canPullDown() && null == mIndicatorIvTop) {
      ...
      params.rightMargin = getResources().getDimensionPixelSize(R.dimen
          .refreshable_widget_indicator_right_padding);
