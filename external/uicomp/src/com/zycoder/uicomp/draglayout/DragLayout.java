...
public abstract class DragLayout extends ViewGroup {
  ...
  protected WeakReference<com.zycoder.uicomp.draglayout.TouchInterceptor> mInterceptorRef;
  ...
  public void registerTouchInterceptor(com.zycoder.uicomp.draglayout.TouchInterceptor interceptor) {
    if (interceptor != null) {
