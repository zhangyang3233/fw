...
/**
 * A {@link ListAdapter} which wraps a {@link StickyHeaderListAdapter} and
 * automatically handles wrapping the result of
 * {@link StickyHeaderListAdapter#getView(int, android.view.View, android.view.ViewGroup)} and
 * {@link StickyHeaderListAdapter#getHeaderView(int, android.view.View, android.view.ViewGroup)}
 * appropriately.
 *
...
class InternalAdapterWrapper extends BaseAdapter implements StickyHeaderListAdapter {
  ...
  InternalAdapterWrapper(Context context,
