...
public class RefreshableStickyHeaderListView
    extends PullToRefreshAdapterViewBase<StickyHeaderListView> {
  ...
  public RefreshableStickyHeaderListView(Context context, AttributeSet attrs) {
    super(context, attrs);
    setDisableScrollingWhileRefreshing(false);
  }

  public RefreshableStickyHeaderListView(Context context, Mode mode) {
    super(context, mode);
    setDisableScrollingWhileRefreshing(false);
  }
  ...
  protected StickyHeaderListView createListView(Context context, AttributeSet attrs) {
    final StickyHeaderListView lv;
  ...
  @Override
  protected final StickyHeaderListView createRefreshableView(Context context,
      AttributeSet attrs) {
    StickyHeaderListView lv = createListView(context, attrs);
  ...
  final class InternalListViewSDK9 extends InternalListView {
    ...
    protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
      ...
      OverscrollHelper.overScrollBy(RefreshableStickyHeaderListView.this, deltaY,
  ...
  protected class InternalListView extends StickyHeaderListView implements
    ...
    public void setEmptyView(View emptyView) {
      RefreshableStickyHeaderListView.this.setEmptyView(emptyView);
    }
