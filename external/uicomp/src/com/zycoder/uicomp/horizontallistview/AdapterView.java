...
public abstract class AdapterView<T extends Adapter> extends ViewGroup {
  ...
  public interface OnItemSelectedListener {
    ...
    /**
     * <p>
     * Callback method to be invoked when an item in this view has been selected. This callback is
     * invoked only when the newly selected position is different from the previously selected
   ...
   *         the view does not correspond to a
  ...
  /**
   * Searches the adapter for a position matching mSyncColId. The search
   ...
   * 
   * @return Position of the col that matches mSyncColId, or {@link #INVALID_POSITION} if it can't
   *         be found
   */
