 ...
 * a scrolling operation. This class is a drop-in replacement for {@link android.widget.Scroller} in
 * most cases.
 */
public class OverScroller {
   ...
   * the animation to finished does NOT
   ...
   * 
   * One should check this value before calling {@link #startScroll(int, int, int, int)} as the
