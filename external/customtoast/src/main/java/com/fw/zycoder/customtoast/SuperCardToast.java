...
import com.fw.zycoder.customtoast.utils.OnClickWrapper;
import com.fw.zycoder.customtoast.utils.OnDismissWrapper;
import com.fw.zycoder.customtoast.utils.Style;
import com.fw.zycoder.customtoast.utils.SwipeDismissListener;
import com.fw.zycoder.customtoast.utils.Wrappers;
...
public class SuperCardToast {
  ...
  private static final String ERROR_ACTIVITYNULL =
      " - You cannot pass a null Activity as a parameter.";
  private static final String ERROR_CONTAINERNULL =
      " - You must have a LinearLayout with the id of card_container in your layout!";
  private static final String ERROR_VIEWCONTAINERNULL =
      " - Either the View or Container was null when trying to dismiss.";
  private static final String ERROR_NOTBUTTONTYPE =
      " is only compatible with BUTTON type SuperCardToasts.";
  private static final String ERROR_NOTPROGRESSHORIZONTALTYPE =
      " is only compatible with PROGRESS_HORIZONTAL type SuperCardToasts.";

  private static final String WARNING_PREHONEYCOMB =
      "Swipe to dismiss was enabled but the SDK version is pre-Honeycomb";
   ...
   *
   * @param activity {@link Activity}
   * @param type {@link SuperToast.Type}
   */
  @SuppressWarnings("ConstantConditions")
   ...
   *
   */
  public void setIcon(int icon, SuperToast.IconPosition iconPosition) {
