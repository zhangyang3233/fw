...
public class RequestQueueIntegrationTest {
  ...
  public void add_requestProcessedInCorrectOrder() throws Exception {
    // Enqueue 2 requests with different cache keys, and different priorities. The second, higher
    // priority request
    // takes 20ms.
    ...
    // as an alternative, first verify no requests have finished, while higherPriorityReq should be
    // processing
