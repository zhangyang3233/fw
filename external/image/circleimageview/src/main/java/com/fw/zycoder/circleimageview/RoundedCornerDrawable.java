...
public class RoundedCornerDrawable extends Drawable {
   ...
   * @return the {@link RoundedCornerDrawable} for chaining.
   */
  public RoundedCornerDrawable setCornerRadius(@Corner int corner, float radius) {
   ...
   * @return the {@link RoundedCornerDrawable} for chaining.
   */
  public RoundedCornerDrawable setCornerRadius(float topLeft, float topRight, float bottomRight,
      float bottomLeft) {
  ...
  public RoundedCornerDrawable setBorderWidth(float width) {
    mBorderWidth = width;
    mBorderPaint.setStrokeWidth(mBorderWidth);
    return this;
  }
  ...
  public RoundedCornerDrawable setOval(boolean oval) {
    mOval = oval;
    return this;
  }
  ...
  public RoundedCornerDrawable setScaleType(ScaleType scaleType) {
    if (scaleType == null) {
  ...
  public RoundedCornerDrawable setTileModeX(Shader.TileMode tileModeX) {
  ...
  public RoundedCornerDrawable setTileModeY(Shader.TileMode tileModeY) {
